...
const variants: Record<Variant, string> = {
  ...
  ghost: 'text-text-secondary hover:bg-bg-raised hover:text-text-primary active:bg-bg-subtle',
  destructive: 'bg-error text-white hover:bg-red-700 active:bg-red-800 shadow-sm'
}
