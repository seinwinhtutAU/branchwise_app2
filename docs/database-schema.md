...
| summary              | JSON               | the same counts dict the confirm endpoint returns (`sales_created`, etc.) — also carries `issue_count` and, for sales, `slip_subtotal_mismatches` (see [import_health.md](./retail/import_health.md))                                                                             |
