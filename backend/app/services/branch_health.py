...
1. **Nothing is measured twice.** Every raw number comes from the helpers in
   app/services/dashboard.py (and app/services/data_quality.py) that the Revenue /
...
from app.services import data_quality, explanation
...
# (app/services/pricing.py's point-in-time buying price). Below this share of period
...
def build_overview_dashboard(
    ...
    # Imported here rather than at module scope because app/services/early_warning.py
