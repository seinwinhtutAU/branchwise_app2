...
**Data-integrity alerts delegate to app/retail/services/data_quality.py entirely**, down to
...
from app.retail.services.branch_health import MIN_COST_COVERAGE_PCT, BranchSnapshot
...
class Alert:
    ...
    measure: str
    # Why it happened, from app/retail/services/explanation.py — arithmetic, not a model's
